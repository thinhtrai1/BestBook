...
//         * specific request.
//         */
//        const val PICK_IMAGE_CHOOSER_REQUEST_CODE = 2000
//
//        /** The request code used to request permission to pick image from external storage.  */
//        const val PICK_IMAGE_PERMISSIONS_REQUEST_CODE = 2001
//
...
//         */
//        const val CROP_IMAGE_ACTIVITY_REQUEST_CODE = 2003
//
//        /** The result code used to return error from [CropImageActivity].  */
//        const val CROP_IMAGE_ACTIVITY_RESULT_ERROR_CODE = 2004
//
...
//                intent.putExtra(MediaStore.EXTRA_OUTPUT, getCaptureImageOutputUri(context))
//            } else {
...
//
//        class ActivityBuilder(source: Uri?) {
//
//            /** The image to crop source Android uri.  */
//
//            private var mSource: Uri? = source
//
//            /** Options for image crop UX  */
//            private var mOptions: CropImageOptions = CropImageOptions()
//
...
//             * *Default: 0*
//             */
//            fun setCropMenuCropButtonIcon(drawableResource: Int): ActivityBuilder {
