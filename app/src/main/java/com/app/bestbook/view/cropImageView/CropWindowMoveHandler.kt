 ...
 */(type: Type, cropWindowHandler: CropWindowHandler, touchX: Float, touchY: Float) {
    ...
    private fun moveSizeWithFreeAspectRatio(
        ...
        when (mType) {
            ...
            CropWindowMoveHandler.Type.LEFT -> adjustLeft(
                rect,
                x,
                bounds,
                snapMargin,
            ...
            CropWindowMoveHandler.Type.TOP -> adjustTop(
                rect,
                y,
                bounds,
                snapMargin,
            ...
            CropWindowMoveHandler.Type.RIGHT -> adjustRight(
                rect,
                x,
                bounds,
                viewWidth,
            ...
            CropWindowMoveHandler.Type.BOTTOM -> adjustBottom(
                rect,
                y,
                bounds,
                viewHeight,
    ...
    private fun moveSizeWithFixedAspectRatio(
        ...
        when (mType) {
            CropWindowMoveHandler.Type.TOP_LEFT -> if (calculateAspectRatio(
                    x,
                    y,
                    rect.right,
                    rect.bottom
            ...
            CropWindowMoveHandler.Type.TOP_RIGHT -> if (calculateAspectRatio(
                    rect.left,
                    y,
                    x,
                    rect.bottom
            ...
            CropWindowMoveHandler.Type.BOTTOM_LEFT -> if (calculateAspectRatio(
                    x,
                    rect.top,
                    rect.right,
                    y
            ...
            CropWindowMoveHandler.Type.BOTTOM_RIGHT -> if (calculateAspectRatio(
                    rect.left,
                    rect.top,
                    x,
                    y
