...
//            override fun createFromParcel(source: Parcel): CropImageOptions {
//                return CropImageOptions(source)
//            }
//
...
//    lateinit var outputCompressFormat: Bitmap.CompressFormat
//
...
//        `in`.readString()?.let {
//            outputCompressFormat = Bitmap.CompressFormat.valueOf(it)
//        }
